...
wget  http://pizzachili.dcc.uchile.cl/repcorpus/real/influenza.gz
gunzip influenza.gz
wget  http://pizzachili.dcc.uchile.cl/repcorpus/real/kernel.gz
gunzip kernel.gz
wget  http://pizzachili.dcc.uchile.cl/repcorpus/real/para.gz
gunzip para.gz
#wget  http://pizzachili.dcc.uchile.cl/repcorpus/real/world_leader.gz -o "world_leader.gz"
#gunzip world_leader.gz
